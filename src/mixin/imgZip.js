        ...
        function call_back(data) {
          ...
          if (/\/(?:jpeg|png)/i.test(file.file.type) && file.file.size > 500000) {
            ...
            img.onload = async () => {
              ...
              let canvasHeight = exif_clientHeight
              let canvasWidth = exif_clientWidth
              console.log(Orientation)
              switch (Orientation) {
                case 8:
                  canvas.width = exif_clientHeight
                  canvas.height = exif_clientWidth
